public class AreaCalculator {
    ...
    public static void printAreas(double square, double rectangle, double triangle, double circle) {
        System.out.println("Square: " + areaSquare(square));
        System.out.println("Rectangle: " + areaSquare(rectangle));
        System.out.println("Triangle: " + areaSquare(triangle));
        System.out.println("Circle: " + areaSquare(circle));
    }
